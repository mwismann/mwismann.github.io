...
const userData = {
  name: JSON.parse(localStorage.getItem('userData')).name === null ? '' : JSON.parse(localStorage.getItem('userData')).name,
  email: JSON.parse(localStorage.getItem('userData')).email === null ? '' : JSON.parse(localStorage.getItem('userData')).email,
  message: JSON.parse(localStorage.getItem('userData')).message === null ? '' : JSON.parse(localStorage.getItem('userData')).message,
};
